...
void main(List<String> arguments) {
  ...
  usingClosure(index: 10, completion: (name){
...
void functionWithParamtersRequire({required String name}) => print('Name: '+name);
...
void usingClosure({required int index, required void Function (String name) completion}){
